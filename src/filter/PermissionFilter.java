...
//        response.setCharacterEncoding("UTF-8");
		...
		}else if(servletPath.contains("getcaptcha")||servletPath.equals("/verifyCodeServlet")||servletPath.equals("/getDetailServlet")){
			chain.doFilter(request, response);
		}
		...
		else if(servletPath.equals("/map.jsp")||servletPath.equals("/bbs.jsp")||servletPath.equals("/recommend.jsp")||servletPath.equals("/tags.jsp")){
			chain.doFilter(request, response);
		}
		else if(servletPath!=null&&(servletPath.equals("/login.jsp")||servletPath.equals("/index.jsp")||servletPath.equals("/checkUserServlet")||servletPath.equals("/404.jsp")||servletPath.equals("/register.jsp")||servletPath.equals("/registerServlet")||servletPath.equals("/showdata.jsp")||servletPath.equals("/getPostServlet"))){
